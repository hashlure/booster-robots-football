...
class RewardsCfg:
    ...
    head_height = RewTerm(func=mdp.tracking_head_height, params={"target_head_height": 0.35 ,"threshold": 0.8179, "std": 0.3, "command_name": "base_velocity", "asset_cfg": SceneEntityCfg("robot", body_names=["Head_2"])}, weight=20.0)
